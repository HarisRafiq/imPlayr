...
{
    pthread_setname_np("com.imPlayr.http-request.controller");
...
{
    @autoreleasepool {
        __unsafe_unretained HttpSource *request = (__bridge HttpSource *)clientCallBackInfo;
...
- (void)cancel
{
    ...
    CFRunLoopPerformBlock(controller_get_runloop(), kCFRunLoopDefaultMode, ^{
        @autoreleasepool {
            [(__bridge HttpSource *)__request _closeResponseStream];
