...
- (GLuint)setupTextureFromImage:(UIImage*)image
{
    ...
    CGContextRef inputTextureContext = CGBitmapContextCreate(inputTextureData, width, height, 8, width*4, inputTextureColorSpace , kCGBitmapAlphaInfoMask & kCGImageAlphaPremultipliedLast);
