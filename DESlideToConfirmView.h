...
typedef void (^DESlideToConfirmViewDidIdleBlock2)(DESlideToConfirmView *slideView);
typedef void (^DESlideToConfirmViewDidUpdateBlock2)(DESlideToConfirmView *slideView, float percentage);
typedef void (^DESlideToConfirmViewDidCompleteBlock2)(DESlideToConfirmView *slideView);
...
@property (strong, nonatomic) UIView *customThumbView2;
...
@property (readonly, strong, nonatomic) DESlideToConfirmDefaultThumb *defaultThumb2;
...
@property (nonatomic) DESlideToConfirmViewState currentState2;


@property (copy, nonatomic) DESlideToConfirmViewDidIdleBlock2 idleBlock2;

@property (copy, nonatomic) DESlideToConfirmViewDidUpdateBlock2 updateBlock2;

@property (copy, nonatomic) DESlideToConfirmViewDidCompleteBlock2 completeBlock2;
